...
<head>
    <meta charset="UTF-8">
    <title>Extracurricular Achievements Portal</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="signup.jsp">Student Sign Up</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container text-center mt-5">
        <h1 class="display-4">Welcome to the Student Extracurricular Achievements Portal</h1>
        <p>Track and manage your extracurricular achievements easily.</p>
    </div>
